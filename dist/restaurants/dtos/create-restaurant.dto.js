...
let CreateRestaurantInput = class CreateRestaurantInput extends graphql_1.PickType(restaurant_entity_1.Restaurant, ['name', 'coverImg', 'address',]) {
};
__decorate([
...
], CreateRestaurantOutput.prototype, "restaurantId", void 0);
