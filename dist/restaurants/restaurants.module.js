...
RestaurantsModule = __decorate([
    common_1.Module({
        ...
        providers: [restaurants_resolver_1.RestaurantResolver, restaurants_resolver_1.CategoryResolver, restaurants_service_1.RestaurantService, restaurants_resolver_1.DishResolver]
    })
], RestaurantsModule);
